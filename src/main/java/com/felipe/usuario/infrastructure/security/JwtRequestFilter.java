package com.felipe.usuario.infrastructure.security;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        try {
            ...
            if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
                ...
                final String username = jwtUtil.extrarEmailToken(token);
    ...
    private String buildError(int status, String mensagem, String path, String error) {
        ErrorResponseDTO erroResponseDTO = ErrorResponseDTO.builder()
        ...
        try {
            return objectMapper.writeValueAsString(erroResponseDTO);
